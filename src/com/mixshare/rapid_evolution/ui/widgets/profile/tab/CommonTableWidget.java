...
abstract public class CommonTableWidget extends LazyLoadWidget implements DataConstants, LazyLoaderInterface {
	
	static private Logger log = Logger.getLogger(CommonTableWidget.class);
    ...
    public CommonTableWidget(TableModelManager modelManager, Column defaultSortColumn) {
