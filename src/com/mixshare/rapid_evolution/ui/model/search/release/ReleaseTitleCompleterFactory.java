...
public class ReleaseTitleCompleterFactory implements IndexChangeListener {

    static private Logger log = Logger.getLogger(ReleaseTitleCompleterFactory.class);	
	...
	public ReleaseTitleCompleterFactory() {
	...
	public QCompleter getCompleter() {
		if (cachedCompleter == null) {
		    List<String> wordList = new ReleaseTitleAutoCompleter().getWordList();
