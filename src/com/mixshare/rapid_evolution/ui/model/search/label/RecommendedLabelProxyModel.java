...
public class RecommendedLabelProxyModel extends LabelProxyModel {

	/////////////////
	// CONSTRUCTOR //
	/////////////////
	
	public RecommendedLabelProxyModel(QObject parent, TableModelManager modelManager, SearchTableView searchView) {
		super(parent, modelManager, searchView);		
		((LabelSearchParameters)searchParameters).setInternalItemsOnly(false);
		((LabelSearchParameters)searchParameters).setExternalItemsOnly(true);		
	}
