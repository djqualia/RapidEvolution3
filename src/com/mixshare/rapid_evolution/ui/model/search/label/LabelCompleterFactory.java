...
public class LabelCompleterFactory implements IndexChangeListener {

    static private Logger log = Logger.getLogger(LabelCompleterFactory.class);	
	...
	public QCompleter getCompleter() {
		if (cachedCompleter == null) {
		    List<String> wordList = new LabelAutoCompleter().getWordList();
