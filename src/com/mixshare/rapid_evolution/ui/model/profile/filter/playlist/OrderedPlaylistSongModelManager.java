...
public class OrderedPlaylistSongModelManager extends PlaylistSongModelManager {
	
    static private Logger log = Logger.getLogger(OrderedPlaylistSongModelManager.class);	
	...
	public OrderedPlaylistSongModelManager() { }
	
	public OrderedPlaylistSongModelManager(LineReader lineReader) {
		super(lineReader);
	...
	public Object getSourceData(short columnId, Object record) {
		...
		OrderedPlaylistRecord orderedPlaylist = ((OrderedPlaylistProfile)relativePlaylist).getOrderedPlaylistRecord();
		// can insert model specific columns here
		if (columnId == COLUMN_PLAYLIST_POSITION.getColumnId())
			return orderedPlaylist.getPositionOf(songRecord.getUniqueId());
