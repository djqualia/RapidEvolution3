...
public class StyleSongModelManager extends SongModelManager {

    static private Logger log = Logger.getLogger(StyleSongModelManager.class);	
    ...
    static {
    	try{
    		...
    		BeanInfo info = Introspector.getBeanInfo(StyleSongModelManager.class);
    		PropertyDescriptor[] propertyDescriptors = info.getPropertyDescriptors();
    		for (int i = 0; i < propertyDescriptors.length; ++i) {
    			PropertyDescriptor pd = propertyDescriptors[i];
    			if (pd.getName().equals("profileSongsModel") || pd.getName().equals("relativeStyle")) {
	...
	public StyleSongModelManager() { }
	
	public StyleSongModelManager(LineReader lineReader) {
		super(lineReader);
	...
	public String getTypeDescription() { return "Style Song"; }
	...
	public Object getSourceData(short columnId, Object record) {
		...
		if (columnId == COLUMN_DEGREE.getColumnId()) {
			return new Percentage(songRecord.getActualStyleDegree(relativeStyle.getUniqueId()));
		}
	...
	public void setRelativeStyle(StyleProfile relativeStyle) {
		profileSongsModel = new FilterProfileSongsModel(relativeStyle, this); 
