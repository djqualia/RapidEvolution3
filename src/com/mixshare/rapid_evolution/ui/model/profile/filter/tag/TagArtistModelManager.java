...
public class TagArtistModelManager extends ArtistModelManager {

    static private Logger log = Logger.getLogger(TagArtistModelManager.class);	
    ...
    static {
    	try{
    		...
    		BeanInfo info = Introspector.getBeanInfo(TagArtistModelManager.class);
    		PropertyDescriptor[] propertyDescriptors = info.getPropertyDescriptors();
    		for (int i = 0; i < propertyDescriptors.length; ++i) {
    			PropertyDescriptor pd = propertyDescriptors[i];
    			if (pd.getName().equals("profileArtistsModel") || pd.getName().equals("relativeTag")) {
	...
	public TagArtistModelManager() { }
	
	public TagArtistModelManager(LineReader lineReader) {
		super(lineReader);
	...
	public String getTypeDescription() { return "Tag Artist"; }
	...
	public Object getSourceData(short columnId, Object record) {
		...
		if (columnId == COLUMN_DEGREE.getColumnId()) {
			return new Percentage(artistRecord.getActualTagDegree(relativeTag.getUniqueId()));
		}
	...
	public void setRelativeTag(TagProfile relativeTag) {
		profileArtistsModel = new FilterProfileArtistsModel(relativeTag, this);
