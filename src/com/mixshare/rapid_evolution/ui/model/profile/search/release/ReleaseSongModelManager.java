...
public class ReleaseSongModelManager extends SongModelManager {

    static private Logger log = Logger.getLogger(ReleaseSongModelManager.class);	
    ...
    static {
    	try{
    		...
    		BeanInfo info = Introspector.getBeanInfo(ReleaseSongModelManager.class);
	...
	public ReleaseSongModelManager() { }
	
	public ReleaseSongModelManager(LineReader lineReader) {
		super(lineReader);
	...
	public String getTypeDescription() { return "Release Song"; }
	...
	public void setRelativeRelease(ReleaseProfile relativeRelease) {
		profileSongsModel = new ProfileSongsModel(relativeRelease); 
	}
