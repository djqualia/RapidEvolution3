...
public class LabelSongModelManager extends SongModelManager {

    static private Logger log = Logger.getLogger(LabelSongModelManager.class);	
    ...
    static {
    	try{
    		...
    		BeanInfo info = Introspector.getBeanInfo(LabelSongModelManager.class);
	...
	public LabelSongModelManager() { }
	
	public LabelSongModelManager(LineReader lineReader) {
		super(lineReader);
	...
	public String getTypeDescription() { return "Label Song"; }
	...
	public void setRelativeLabel(LabelProfile relativeLabel) {
		profileSongsModel = new ProfileSongsModel(relativeLabel); 
	}
