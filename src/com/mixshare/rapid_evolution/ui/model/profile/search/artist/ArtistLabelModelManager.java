...
import com.mixshare.rapid_evolution.ui.model.profile.ProfileLabelsModel;
import com.mixshare.rapid_evolution.ui.model.search.label.LabelModelManager;
import com.mixshare.rapid_evolution.util.io.LineReader;
import com.mixshare.rapid_evolution.util.io.LineWriter;

public class ArtistLabelModelManager extends LabelModelManager {

    static private Logger log = Logger.getLogger(ArtistLabelModelManager.class);	
    ...
    transient private ProfileLabelsModel profileLabelsModel;
    
    static {
    	try{
    		// in order for the XMLEncoder to skip transient variables, this is needed
    		BeanInfo info = Introspector.getBeanInfo(ArtistLabelModelManager.class);
    		PropertyDescriptor[] propertyDescriptors = info.getPropertyDescriptors();
    		for (int i = 0; i < propertyDescriptors.length; ++i) {
    			PropertyDescriptor pd = propertyDescriptors[i];
    			if (pd.getName().equals("profileLabelsModel")) {
	...
	public ArtistLabelModelManager() { }
	
	public ArtistLabelModelManager(LineReader lineReader) {
		super(lineReader);
	...
	public String getTypeDescription() { return "Artist Label"; }
	...
	public Object getSourceData(short columnId, Object record) {
		...
		if (columnId == COLUMN_DEGREE.getColumnId()) {
			return new Percentage(profileLabelsModel.getDegree(labelRecord.toString()));
		}
	...
	public void setRelativeArtist(ArtistProfile relativeArtist) {
		profileLabelsModel = new ProfileLabelsModel(relativeArtist); 
	}
