...
public class LabelReleaseModelManager extends ReleaseModelManager {

    static private Logger log = Logger.getLogger(LabelReleaseModelManager.class);	
    ...
    static {
    	try{
    		...
    		BeanInfo info = Introspector.getBeanInfo(LabelReleaseModelManager.class);
	...
	public LabelReleaseModelManager() { }
	
	public LabelReleaseModelManager(LineReader lineReader) {
		super(lineReader);
	...
	public String getTypeDescription() { return "Label Release"; }
	...
	public void setRelativeLabel(LabelProfile relativeLabel) {
		profileReleasesModel = new ProfileReleasesModel(relativeLabel); 
	}
