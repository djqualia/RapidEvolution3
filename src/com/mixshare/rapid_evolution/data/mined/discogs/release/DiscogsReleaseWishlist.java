...
public class DiscogsReleaseWishlist implements Serializable {

    private static final long serialVersionUID = 0L;
    
    static private Logger log = Logger.getLogger(DiscogsReleaseWishlist.class);
    
    private String releaseId;
    private Vector<String> users = new Vector<String>();
    
    public DiscogsReleaseWishlist() { }
    public DiscogsReleaseWishlist(String htmlData) {
        try {
            ...
            prefix = "members want this:</h3><table";
            suffix = "</table>";
            ...
            log.error("DiscogsReleaseWishlist(): error", e);
        }
    }
