package test.com.mixshare.rapid_evolution.data.record.search.release;
...
public class ReleaseRecordTest extends RE3TestCase {
	...
	public void testSerialization() {
		try {		
			...
			XMLSerializer.saveData(release, "data/junit/temp/release.xml");
			release = (ReleaseRecord)XMLSerializer.readData("data/junit/temp/release.xml");
